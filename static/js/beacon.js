    ...
    var e = {
            ...
            168: function (e, t, n) {
                ...
                !(function () {
                    function e(e) {
                        let t = "";
                        t = basePath ? basePath : "".concat(window.location.protocol, "://").concat(window.location.host);
                            ...
                            if (s && p && p.token) {
                                ...
                                document.addEventListener("visibilitychange", function () {
                                    if ("hidden" === document.visibilityState) {
                                        if (L && A()) {
                                            var t = e();
                                            ((null == w ? void 0 : w.url) == t && (null == w ? void 0 : w.triggered)) ||
                                                P(),
                                                _(t);
                                        }
                                        !b && w && ((b = !0), B());
                                ...
                                var L = p && (void 0 === p.spa || !0 === p.spa),
                                    ...
                                    R = function () {
                                        ...
                                        t ? t.then(P) : P(),
                                            (w = { id: l, url: e(), ts: new Date().getTime(), triggered: !0 });
                                    };
                            ...
                            switch (
                                ...
                                case "LCP":
                                    (c = e.attribution) &&
                                        ...
                                        (E.lcp.fp =
                                            null ===
                                                (a = null === (o = c.lcpEntry) || void 0 === o ? void 0 : o.element) ||
                                            void 0 === a
                                                ? void 0
                                ...
                                case "INP":
                                    (null == E.inp || Number(E.inp.value) < Number(e.value)) &&
                                        ...
                                        (c = e.attribution) &&
                                            E.inp &&
                                            ((E.inp.element = c.eventTarget), (E.inp.name = c.eventType)));
                            }
                        }
                        function F() {
                            return s.timeOrigin;
                                    ...
                                    P(function () {
                                        ...
                                        (r = g(e, i, U, t.reportAllChanges)),
                                            a &&
                                                ...
                                                h(function () {
                                                    o(a.takeRecords()),
                                                        i.value < 0 && W() > 0 && ((i.value = 0), (i.entries = [])),
                                                        r(!0);
                                                }),
                                                l(function () {
                                                    (Q = []),
